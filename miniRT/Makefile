...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/03/23 15:33:20 by klima-do          #+#    #+#              #
...
SRCS             = $(wildcard ./srcs/utils/*.c) \
				   ...
				   $(wildcard ./srcs/rt/*.c) \
				   $(filter-out ./srcs/ui/mouse.c, $(wildcard ./srcs/ui/*.c))
OBJS             = $(SRCS:.c=.o)
...
$(NAME): $(OBJS)
	$(MAKE) -C $(LIBFT_DIR)
	$(MAKE) -C $(LIBMLX_DIR)
	$(CC) -g3 $(OBJS) $(CFLAGS) $(LDFLAGS) $(LIBFT_FLAGS) $(LIBMLX_FLAGS) -L $(LIBFT_DIR) -L $(LIBMLX_DIR) -o $(NAME)
...
dev: CFLAGS += $(CDEBUG)
dev: $(OBJS)
	$(CC) $(OBJS) $(CFLAGS) $(LDFLAGS) $(LIBFT_FLAGS) $(LIBMLX_FLAGS) -L $(LIBFT_DIR) -L $(LIBMLX_DIR) -o $(NAME)
	$(MAKE) run
