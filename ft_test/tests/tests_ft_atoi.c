...
MU_TEST(test_atoi_entering_minus_minus_1042_char_to_return_0_integer)
{
	// ARRANGE
	char *c = "--1042";
...
MU_TEST(test_atoi_entering_1042e2_char_to_return_1042_integer)
{
	// ARRANGE
	char *c = "1042e2";
	int expected_result = 1042;
...
MU_TEST(test_atoi_entering_MAX_INT_plus_one_char_to_return_minus_2147483648_integer)
{
	// ARRANGE
	char *c = "2147483648";
...
MU_TEST(test_atoi_entering_MAX_INT_char_to_return_2147483647_integer)
{
	// ARRANGE
	char *c = "2147483647";
...
MU_TEST_SUITE(ft_atoi_test_suite) 
{
	...
	MU_RUN_TEST(test_atoi_entering_minus_minus_1042_char_to_return_0_integer);
	MU_RUN_TEST(test_atoi_entering_1042e2_char_to_return_1042_integer);
	MU_RUN_TEST(test_atoi_entering_MAX_INT_plus_one_char_to_return_minus_2147483648_integer);
	MU_RUN_TEST(test_atoi_entering_MAX_INT_char_to_return_2147483647_integer);
}